...
<!-- EVENTS -->
<section class="pa-media-events">
	<div class="container">
		<div class="row">
			<div class="col">
				<div class="events-list-header pa-header__mid">
					Events
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
			<?php echo do_shortcode('[ajax_load_more id="eventList" loading_style="infinite fading-blocks" repeater="template_1" post_type="events" meta_key="event_end_date" posts_per_page="5" scroll="false" orderby="meta_value_num" button_label="More"]'); ?>
			</div>
