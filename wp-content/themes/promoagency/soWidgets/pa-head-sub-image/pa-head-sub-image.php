...
/*
Widget Name: PA Header Subheader Image
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: 
*/

class pa_head_sub_image extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-head-sub-image',
			__('PA Header Subheader Image', 'pa-sowidgets'),
			array(
                'description' => __('PA Header Subheader Image', 'pa-sowidgets'),
        ...
        return array(
            ...
            'widget_content' => array(
				...
				'fields' => array(
                    ...
                    'image' => array(
                        'type' => 'media',
                        'label' => __( 'Widget content (image)', 'pa-sowidgets' ),
                    ...
                    'image_shadow' => array(
                        'type' => 'checkbox',
                        'label' => __( 'Turn off image shadow?', 'pa-sowidgets' ),
                        'default' => false
                    ),
                ),
            ),
	...
	function get_template_name($instance) {
		return 'pa-head-sub-image-template';
	}

	function get_style_name($instance) {
		return 'pa-head-sub-image-style';
    }
...
siteorigin_widget_register('pa-head-sub-image', __FILE__, 'pa_head_sub_image');