...
/*
Widget Name: PA Contact us - three contacts 
...
class pa_contact_two extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-contact-two',
			__('PA Contact us - three contacts', 'pa-sowidgets'),
			array(
                'description' => __('PA Contact us - three contacts', 'pa-sowidgets'),
        ...
        return array(
            ...
            'person_1' => array(
				...
				'fields' => array(
                    ...
                    'box_color' => array(
                        'type' => 'color',
                        'label' => __( 'recommended colors for this section: #79bede or #004387 or #9cc85d', 'pa-sowidgets' ),
                        'default' => '#004387'
                    )
                ),
            ),
	...
	function get_template_name($instance) {
		return 'pa-contact-two-template';
	}

	function get_style_name($instance) {
		return 'pa-contact-two-style';
    }
    ...
    function get_less_variables( $instance ) {
        return array(
            ...
            'box_three_color' => ($instance['person_3']['box_color'])
        );
    }
    
}

siteorigin_widget_register('pa-contact-two', __FILE__, 'pa_contact_two');