...
/*
Widget Name: PA Box - TIA
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_box_tia extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-box-tia',
			__('PA Box - TIA', 'pa-sowidgets'),
			array(
                'description' => __('PA Box - TIA', 'pa-sowidgets'),
        ...
        return array(
            ...
            'a_repeater' => array(
                ...
                'fields' => array(
                    ...
                    'repeat_image_reverse' => array(
                        'type' => 'media',
                        'library' => 'image',
                        'label' => __('Image on hover', 'pa-sowidgets' ),
                    ),
                    'repeat_title' => array(
                        'type' => 'text',
                        'label' => __( 'Title', 'pa-sowidgets' )
	...
	function get_template_name($instance) {
		return 'pa-box-tia-template';
	}

	function get_style_name($instance) {
		return 'pa-box-tia-style';
    }
...
siteorigin_widget_register('pa-box-tia', __FILE__, 'pa_box_tia');