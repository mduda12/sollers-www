...
/*
Widget Name: PA GOQU - columns
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_misc_goqu extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-misc-goqu',
			__('PA GOQU - columns', 'pa-sowidgets'),
			array(
                'description' => __('PA GOQU - columns', 'pa-sowidgets'),
    ...
    function get_widget_form() {
        return array(
            ...
            'column_one' => array(
				'type' => 'section',
				'label' => __('Column 1', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'title' => array(
                        'type' => 'tinymce',
            ...
            'column_two' => array(
				'type' => 'section',
				'label' => __('Column 2', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'title' => array(
                        'type' => 'tinymce',
            ...
            'column_three' => array(
				'type' => 'section',
				'label' => __('Column 3', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'title' => array(
                        'type' => 'tinymce',
	...
	function get_template_name($instance) {
		return 'pa-misc-goqu-template';
	}

	function get_style_name($instance) {
		return 'pa-misc-goqu-style';
    }
...
siteorigin_widget_register('pa-misc-goqu', __FILE__, 'pa_misc_goqu');