...
/*
Widget Name: PA Steps RIFE - 03
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: 
*/

class pa_steps_rife_03 extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-steps-rife-03',
			__('PA Steps RIFE - step 3', 'pa-sowidgets'),
			array(
                'description' => __('PA Steps RIFE - step 3', 'pa-sowidgets'),
    ...
    function get_widget_form() {
        return array(
            ...
            'widget_image' => array(
				'type' => 'section',
				'label' => __('Step 3 image', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'image' => array(
                        'type' => 'media',
            ...
            'widget_content' => array(
				'type' => 'section',
				'label' => __('Step 3 content', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'number' => array(
                        'type' => 'text',
	...
	function get_template_name($instance) {
		return 'pa-steps-rife-03-template';
	}

	function get_style_name($instance) {
		return 'pa-steps-rife-03-style';
    }
...
siteorigin_widget_register('pa-steps-rife-03', __FILE__, 'pa_steps_rife_03');