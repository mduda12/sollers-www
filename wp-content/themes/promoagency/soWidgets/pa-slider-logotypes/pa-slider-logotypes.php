...
/*
Widget Name: PA Slider - logotypes
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_slider_logotypes extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-slider-logotypes',
			__('PA Slider - logotypes', 'pa-sowidgets'),
			array(
                'description' => __('PA Slider - logotypes', 'pa-sowidgets'),
	...
	function get_template_name($instance) {
		return 'pa-slider-logotypes-template';
	}

	function get_style_name($instance) {
		return 'pa-slider-logotypes-style';
    }
...
siteorigin_widget_register('pa-slider-logotypes', __FILE__, 'pa_slider_logotypes');