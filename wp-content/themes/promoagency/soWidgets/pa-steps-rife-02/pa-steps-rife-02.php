...
/*
Widget Name: PA Steps RIFE - 02
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: 
*/

class pa_steps_rife_02 extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-steps-rife-02',
			__('PA Steps RIFE - step 2', 'pa-sowidgets'),
			array(
                'description' => __('PA Steps RIFE - step 2', 'pa-sowidgets'),
    ...
    function get_widget_form() {
        return array(
            ...
            'widget_content' => array(
				'type' => 'section',
				'label' => __('Step 2 content', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'image' => array(
                        'type' => 'media',
	...
	function get_template_name($instance) {
		return 'pa-steps-rife-02-template';
	}

	function get_style_name($instance) {
		return 'pa-steps-rife-02-style';
    }
...
siteorigin_widget_register('pa-steps-rife-02', __FILE__, 'pa_steps_rife_02');