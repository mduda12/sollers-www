<?php $second_contact_person = $instance['person_2']['box_name']; ?>
<section class="pa-contact-one <?php $background = ($instance['widget_settings']['widget_bg']); if($background) : echo 'pa-background'; endif; $alternative = ($instance['widget_settings']['widget_alternative']); if($alternative) : echo ' pa-alternative'; endif; ?>">
	<div class="container">
		<div class="row">
			<div class="col-lg-4 <?php if(!$second_contact_person) { echo 'offset-lg-2'; } ?>">
