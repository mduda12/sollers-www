...
/*
Widget Name: PA Slider - like Moody's
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_slider_moodys extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-slider-moodys',
			__('PA Slider - like Moodys', 'pa-sowidgets'),
			array(
                'description' => __('PA Slider - like Moodys', 'pa-sowidgets'),
                    ...
                    'a_repeater' => array(
                        ...
                        'fields' => array(
                            ...
                            'image_2' => array(
                                'type' => 'media',
                                'library' => 'image',
                                'label' => __('Image Two', 'pa-sowidgets' ),
                                'optional' => true
                            ),
                            'title' => array(
                                'type' => 'text',
	...
	function get_template_name($instance) {
		return 'pa-slider-moodys-template';
	}

	function get_style_name($instance) {
		return 'pa-slider-moodys-style';
    }
...
siteorigin_widget_register('pa-slider-moodys', __FILE__, 'pa_slider_moodys');