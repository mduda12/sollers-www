...
/*
Widget Name: PA Text with Header | Universal
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_txt_header_universal extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-txt-header-universal',
			__('PA Text with Header | Universal', 'pa-sowidgets'),
			array(
                'description' => __('PA Text with Header | Universal', 'pa-sowidgets'),
	...
	function get_template_name($instance) {
		return 'pa-txt-header-universal-template';
	}

	function get_style_name($instance) {
		return 'pa-txt-header-universal-style';
    }
...
siteorigin_widget_register('pa-txt-header-universal', __FILE__, 'pa_txt_header_universal');