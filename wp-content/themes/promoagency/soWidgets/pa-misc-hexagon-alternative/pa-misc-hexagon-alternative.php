...
/*
Widget Name: PA Hexagon list - like Agile Philosophy
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: 
*/

class pa_misc_hexagon_alternative extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-misc-hexagon-alternative',
			__('PA Hexagon list - like Agile Philosophy', 'pa-sowidgets'),
			array(
                'description' => __('PA Hexagon list - like Agile Philosophy', 'pa-sowidgets'),
				...
				'fields' => array(
                    ...
                    'a_repeater' => array(
                        ...
                        'fields' => array(
                            'content' => array(
                                'type' => 'tinymce',
                                'label' => __( 'Front: Content', 'pa-sowidgets' ),
                                'rows' => 5,
                                'default_editor' => 'tinymce',
                            ),
	...
	function get_template_name($instance) {
		return 'pa-misc-hexagon-alternative-template';
	}

	function get_style_name($instance) {
		return 'pa-misc-hexagon-alternative-style';
    }
...
siteorigin_widget_register('pa-misc-hexagon-alternative', __FILE__, 'pa_misc_hexagon_alternative');