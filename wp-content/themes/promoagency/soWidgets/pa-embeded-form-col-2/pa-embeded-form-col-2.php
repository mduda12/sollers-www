...
/*
Widget Name: PA embeded form 2 columns
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: 
*/

class pa_embeded_form_two extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-embeded-form-col-2',
			__('PA embeded form 2 columns', 'pa-sowidgets'),
			array(
                'description' => __('PA embeded form 2 columns', 'pa-sowidgets'),
                'panels_groups' => array('pa_form_widgets'),
			),
			array(
    ...
    function get_widget_form() {
        return array(
            ...
            'ordering' => array(
                ...
                'options' => array(
                    'left' => __( 'Form - left | Image - right', 'pa-sowidgets' ),
                    'right' => __( 'Form - right | Image - left', 'pa-sowidgets' ),
                ),
                'default' => array( 'left', 'right' ),
            ),
            'column_form' => array(
				'type' => 'section',
				'label' => __('Form column', 'pa-sowidgets'),
				'hide' => true,
				'fields' => array(
                    'header' => array(
                        'type' => 'tinymce',
	...
	function get_template_name($instance) {
		return 'pa-embeded-form-col-2-template';
	}

	function get_style_name($instance) {
		return 'pa-embeded-form-col-2-style';
    }
...
siteorigin_widget_register('pa-embeded-form-col-2', __FILE__, 'pa_embeded_form_two');