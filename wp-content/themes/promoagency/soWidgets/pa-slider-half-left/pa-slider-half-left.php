...
/*
Widget Name: PA Slider - half left
Description: A section with a slider on the left and a static photo on the right. SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_slider_half_left extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-slider-half-left',
			__('PA Slider - half left', 'pa-sowidgets'),
			array(
                'description' => __('PA Slider - half left', 'pa-sowidgets'),
	...
	function get_template_name($instance) {
		return 'pa-slider-half-left-template';
	}

	function get_style_name($instance) {
		return 'pa-slider-half-left-style';
    }
...
siteorigin_widget_register('pa-slider-half-left', __FILE__, 'pa_slider_half_left');