...
/*
Widget Name: PA Box - UX
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: MK
*/

class pa_box_ux extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-box-ux',
			__('PA Box - UX', 'pa-sowidgets'),
			array(
                'description' => __('PA Box - UX', 'pa-sowidgets'),
	...
	function get_template_name($instance) {
		return 'pa-box-ux-template';
	}

	function get_style_name($instance) {
		return 'pa-box-ux-style';
    }
...
siteorigin_widget_register('pa-box-ux', __FILE__, 'pa_box_ux');