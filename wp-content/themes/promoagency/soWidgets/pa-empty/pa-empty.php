...
/*
Widget Name: PA Empty
Description: SiteOrigin Widgets Bundle is required to work.
Author: PromoAgency
Developer: 
*/

class pa_empty extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'pa-empty',
			__('PA Empty', 'pa-sowidgets'),
			array(
                'description' => __('PA Empty', 'pa-sowidgets'),
	...
	function get_template_name($instance) {
		return 'pa-empty-template';
	}

	function get_style_name($instance) {
		return 'pa-empty-style';
    }
...
siteorigin_widget_register('pa-empty', __FILE__, 'pa_empty');