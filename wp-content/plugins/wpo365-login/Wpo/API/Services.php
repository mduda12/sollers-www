        ...
        class Services  {
            ...
            public static function delete_tokens() {
                ...
                try {
                    ...
                    delete_option( Auth::SITE_META_ACCESS_TOKEN );
            ...
            public static function get_self_test_results() {
                // Verify AJAX request
                $current_user = Services::verify_ajax_request( 'to get the wpo365-login self-test results' );
                
                if( false === Helpers::user_is_admin( $current_user ) ) {
                    Logger::write_log( 'ERROR', 'User has no permission to get self-test results from AJAX service' );
                    wp_die();
                }

                $self_test_results = Helpers::mu_get_transient( 'wpo365_self_test_results' );
