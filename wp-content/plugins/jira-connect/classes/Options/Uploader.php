...
class Uploader {
    ...
    private static $options_key = 'jira-connect';
     ...
     * @param Loader $loader
     *
     * @uses \pkarecki\OptionsFramework\Uploader::optionsframework_media_scripts()
     *
     */
    private function define_hooks(Loader $loader) {
        //Uploader init
        $loader->add_action('admin_enqueue_scripts', $this, 'optionsframework_media_scripts');
    }
    ...
    static function optionsframework_uploader($_id, $_value, $_desc = '', $_name = '') {
        ...
        $optionsframework_settings = get_option(self::$options_key);
    ...
    function optionsframework_media_scripts($hook) {
        ...
        $menu = AdminController::menu_settings();
