...
class Generator {
    ...
    static $options_key = 'jira-connect';
    ...
    static function optionsframework_fields() {
        ...
        foreach ($options as $value) {
            ...
            switch ($value['type']) {
                ...
                // Uploader
                case "upload":
                    $output .= Uploader::optionsframework_uploader($value['id'], $val, null);
                ...
                case 'background':
                    ...
                    $output .= Uploader::optionsframework_uploader($value['id'], $background['image'], null, esc_attr($option_name . '[' . $value['id'] . '][image]'));
                ...
                case "heading":
                    ...
                    $output .= '<h3>' . esc_html($value['desc']) . '</h3>' . "\n";
                    break;
            }
        ...
        if (Generator::optionsframework_tabs() != '') {
            echo '</div>';
        }
    }
