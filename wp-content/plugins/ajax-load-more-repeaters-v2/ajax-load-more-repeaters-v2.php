...
define('ALM_UNLIMITED_VERSION', '2.5.5');
define('ALM_UNLIMITED_RELEASE', 'December 6, 2019');
         				...
         				<div class="wrap repeater-wrap" data-name="<?php echo $repeater_file; ?>" data-type="unlimited">
            				...
            				<div class="alm-row alm-row--margin-btm">
            				   <div class="column column--half">
               			      <label class="template-title has-margin-btm" for="alias-<?php echo $repeater_file; ?>">
               			         <?php _e('Template Alias:', 'ajax-load-more-repeaters-v2'); ?>
               			         <span><?php _e('Enter a unique name for this template.', 'ajax-load-more-repeaters-v2'); ?></span>
               			      </label>
               			      <?php
                  			      $alias = (empty($repeater_alias)) ? $repeater_name : $repeater_alias;
                  			      echo '<input type="text" id="alias-'.$repeater_file.'" class="_alm_repeater_alias" value="'.$alias.'" maxlength="55" placeholder="'. __('Blog Listing', 'ajax-load-more-repeaters-v2') .'">';
               			      ?>
            				   </div>
            				   <div class="column column--half">
            			         <label class="template-title has-margin-btm" for="id-<?php echo $repeater_file; ?>">
               			         <?php _e('Template ID:', 'ajax-load-more-repeaters-v2'); ?>
               			         <span><?php _e('The unique ID assigned to this template (non-editable).', 'ajax-load-more-repeaters-v2'); ?></span>
                              </label>
         				   ...
         				   <div class="alm-row alm-row--margin-btm">
                              ...
                              <label class="template-title trigger-codemirror" data-id="<?php echo $repeater_file; ?>" for="template-<?php echo $repeater_file; ?>">                              
					                  <?php _e('Template Code:', 'ajax-load-more-repeaters-v2'); ?>
					                  <span><?php _e('Enter the PHP and HTML markup for this template.', 'ajax-load-more-repeaters-v2'); ?></span>
                              </label>
            				   </div>
